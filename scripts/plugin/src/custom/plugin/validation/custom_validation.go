...
func (*CustomValidationFactory) New() validation.Plugin {
	fmt.Println("Custom Validation Plugin : New()")
...
func (v *CustomValidation) Validate(block *common.Block, namespace string, txPosition int, actionPosition int, contextData ...validation.ContextDatum) error {
	fmt.Println("Custom Validation Plugin : Validate")
...
func convertErrorTypeOrPanic(err error) error {
	fmt.Println("Custom Validation Plugin : convertErrorTypeOrPanic")
	if err == nil {
		return nil
	}
...
func (v *CustomValidation) Init(dependencies ...validation.Dependency) error {
	fmt.Println("Custom Validation Plugin : Init")
	var (
...
func NewPluginFactory() validation.PluginFactory {
	fmt.Println("Custom Validation Plugin : NewPluginFactory")
	return &CustomValidationFactory{}
}

func main() {
	fmt.Println("custom validation plugin main")
}
